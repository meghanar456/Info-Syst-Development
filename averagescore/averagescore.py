...
class Ui_averageScore(object):
    def setupUi(self, averageScore):
        ...
        #Creating an empty ptyhon list named student_scores_lst to store student scores
    ...
    def retranslateUi(self, averageScore):
        ...
        self.lblScore.setText(_translate("averageScore", "Student Score"))
