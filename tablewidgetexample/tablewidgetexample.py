...
class Ui_tableWidgetExample(object):
    def setupUi(self, tableWidgetExample):
        ...
        self.btnDisplay.setGeometry(QtCore.QRect(350, 120, 75, 23))
        self.btnDisplay.setObjectName("btnDisplay")
        self.tblWidgetStudentData = QtWidgets.QTableWidget(parent=self.centralwidget)
        self.tblWidgetStudentData.setGeometry(QtCore.QRect(180, 200, 431, 192))
        ...
        self.connecttodb()
        self.load_data()
        self.btnDisplay.clicked.connect(self.diaply_data)
    ...
    def diaply_data(self):
        try:
            ...
            col_header = ["Student Id", "Student Name", "Studegt age", "Student Score"]
            ...
            for rownumber, rowdata in enumerate(results):
                for colnumber, coldata in enumerate(rowdata):
                    self.tblWidgetStudentData.setItem(rownumber, colnumber, QTableWidgetItem(str(coldata)))
        except Exception as e:
            print(e)
        finally:
            connectionobj.close()    
